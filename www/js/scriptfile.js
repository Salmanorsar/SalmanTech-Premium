 $(document).bind("pageinit", function() {
	...
	$("#OpenCompleteExCon").bind("tap", function() {
		...
		else if (checkpassword == window.localStorage.getItem("user") && window.localStorage.getItem("user") != "")
		{
			$("#imgval").show();
			$("#imgval").attr("src", "../res/green_ok.png").trigger("refresh");
			$("#imgAct").show();
...
$('#CompleteExCon').live('pageinit', function() {
	if (window.localStorage.getItem("user") != "")
	{
		$('#loginmsg').html('<font face="droid"><p>The Complete Grade Point Calculator provides ' +
			'an extra window complete enough to calculate your exams and continuous ' +
...
$('#Help').live("pageinit", function() {
	...
	$('#MainIntro').click(function() {
		$('#ControlRight').html('<h5><font color="#3151aa" face="droid" size="2px">Salmantech Grade Point ' + 
		'Calculator</font></h5>' + 
		...
		' again and again.' + 
		'<hr class="ui-btn-hover-c">With this program ' +
		...
		'friendly tips.' + 
		'<hr class="ui-btn-hover-c">With all due regards and diligence I have tried my best to' + 
		...
		'that it can also be of help to lecturers and the Exams Office.<hr class="ui-btn-hover-c">Even though  ' +
		...
		'grade points ([d] 1.75).<hr class="ui-btn-hover-c">Feel free to explore its limits. I hope you may ' +
		'find it very helpful and handy.</font></p><hr class="ui-btn-hover-c"><font color="black" face="droid" size="2px">' + 
		'SalmanTech | Grade Point ' + 
		'Calculator<br>All Right Reserved &copy; 2015</font>');
	});
	
	$('#MainPro').click(function() {
		$('#ControlRight').html('<h5><font color="#3151aa" face="droid" size="2px">Procedure of Use</font></h5>  ' +
	...
	$('#MainSec1').click(function() {
		$('#ControlRight').html('<h5><font color="#3151aa" face="droid" size="2px">Section One The menu bar</font></h5> ' + 
		...
		'the calculate button.<br><hr class="ui-btn-hover-c">This window may also be important if your ' +
		'total grades have already been calculated. You can use this window to quickly ' +
		'verify your grades just as you might use your calculator.</p><hr class="ui-btn-hover-c"> <p>The Cumulated grade ' +
		...
		'your cumulated average grade point. <hr class="ui-btn-hover-c">The cumulated grade point will be on ' +
		'a separate text field to ensure that a good display of both the total average ' +
		'grades points and the cumulated grade point is achieved.</p><hr class="ui-btn-hover-c"><br>The About Button ' + 
		...
		'give you a first hand knowledge of what this program is designed to do.<hr class="ui-btn-hover-c"><p>The Help Button: ' + 
		'<br>The help button located'+ 
		' in the Title Bar of the About window, will lunch this help page.</font></p>');
	});
	
	$('#MainSec2').click(function() {
		$('#ControlRight').html('<h5><font color="#3151aa" face="droid" size="2px">Section Two The Grade Input Panel</font></h5>' + 
	...
	$('#MainSec3').click(function() {
		$('#ControlRight').html('<h5><font color="#3151aa" face="droid" size="2px">Section Three The Result Panel</font></h5>' + 
		' <p><font face="droid">This panel displays all ' +
		'your grade points in the order in which you previously entered them.</p> <p>Your average grade ' +
	...
	$('#MainSec4').click(function() {
		$('#ControlRight').html('<h5><font color="#3151aa" face="droid" size="2px">Section Four The Buttons</font></h5> ' + 
		'<p><font face="droid">This section holds most of the ' +
		'controls you would need to perform the calculation.</p><hr class="ui-btn-hover-c"><p>The Calculate Button:<br>' +
		...
		'<hr class="ui-btn-hover-c"><p>The Clear Button: <br>This button clears all text areas of the windows, making it ' +
		...
		'clicking this button.</p><hr class="ui-btn-hover-c"><p>The Save Button: <br>Use this button to save ' + 
		...
		'the screen.</p> ' + '<hr class="ui-btn-hover-c"><p>The Retrieve Button: <br>This button ' +
		"is used to retrieve saved information. After you've calculated your grades, and save them to the system," +
		" this button will be very helpful to retrieve the most recently saved information. <hr class='ui-btn-hover-c'>" +
	...
	$('#ECOverview').click(function() {
		$('#ControlRight').html('<h5><font color="#3151aa" face="droid" size="2px">The Exam Continuous Window</font></h5> ' + 
	...
	$('#ECPro').click(function() {
		$('#ControlRight').html('<h5><font color="#3151aa" face="droid" size="2px">Exam and Continuous Grades Calculator</font></h5> ' + 
		...
		'<hr class="ui-btn-hover-c"><p><i>As you may have noticed, this program ' +
		...
		'functional and useful application such as this.</i></p> <hr class="ui-btn-hover-c">' +
		...
		'be numeric.</i></font></p> <hr class="ui-btn-hover-c"> <p><font color="red">Caution:</font> The grades in this ' + 
		...
		'<hr class="ui-btn-hover-c"><p>Basically, this window ' +
	...
	$("#ECCompPro").click(function() {
		$('#ControlRight').html('<h5><font color="#3151aa" face="droid" size="2px">Complete Grade Point Calculator</font></h5>' +
		...
		'<hr class="ui-btn-hover-c">With this window all you need to do is input just your exams and continuous ' +
		...
		'the Average Grade Point.<hr class="ui-btn-hover-c">However this window is only available in ' +
		'the registered version of this application. Registeration can be obtained through filing in a 15-character ' +
		' registration key e.g. xxxxx-xxxxx-xxxxx. <hr class="ui-btn-hover-c">Feel free to access all the' +
		' capability of this application and enjoy.</font>' +
		'<font color="black" face="droid" size="2px"><hr class="ui-btn-hover-c">SalmanTech | Grade Point ' + 
		'Calculator<br>All Right Reserved &copy; 2015</font>');
	});
	
	$('#CumuOverview').click(function() {
		$('#ControlRight').html('<h5><font color="#3151aa" face="droid" size="2px">The Cumulated Window</font></h5> ' + 
		...
		'successfully proceed to the next year.<hr class="ui-btn-hover-c">And if without any reference in year one and two' + 
		' ,with 3.00 points you may proceed' +
		' to the <i>Honours</i> department.</font></p>');
	});
	
	$('#CumuPro').click(function() {
		$('#ControlRight').html('<h5><font color="#3151aa" face="droid" size="2px">Cumulated Grade Window</font></h5> '+ 
		...
		'navigation button to display this window.</p> <hr class="ui-btn-hover-c"> <p>If you wish to calculate for only one year. Click' +
		...
		'information into the required field.<hr class="ui-btn-hover-c"> <p>When quite ' +
		...
		'Point.</p><hr class="ui-btn-hover-c"><p>If by any chance you mistakenly entered wrong information, and intend ' +
...
$('#ExamCon').live("pageinit", function() {
	...
	$("#ECCalBtn").bind("tap", function() {
		...
		$('#Ex1').css({"color" : "#000000"});
		$('#Con1').css({"color" : "#000000"});
		
		$('#Ex2').css({"color" : "#000000"});
		$('#Con2').css({"color" : "#000000"});
		
		$('#Ex3').css({"color" : "#000000"});
		$('#Con3').css({"color" : "#000000"});
		
		$('#Ex4').css({"color" : "#000000"});
		$('#Con4').css({"color" : "#000000"});
		
		$('#Ex5').css({"color" : "#000000"});
		$('#Con5').css({"color" : "#000000"});
		
		$('#Ex6').css({"color" : "#000000"});
		$('#Con6').css({"color" : "#000000"});
